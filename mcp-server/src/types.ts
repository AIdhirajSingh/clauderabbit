 ...
 * tool output are typed loosely (`unknown`)  rather than omitted, so an
 * unexpected upstream shape does not throw — see `normalizeReport`.
 */
 ...
 * `_ranSandbox` derivation). This server must never conflate the two.
 */
